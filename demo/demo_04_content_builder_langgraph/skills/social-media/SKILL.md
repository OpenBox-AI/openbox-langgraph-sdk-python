...
**Before writing any social media content, you MUST research the topic yourself:**
...
```
web_search(query="renewable energy trends 2025")
write_file(file_path="research/renewable-energy.md", content="<summarized findings with sources>")
```

3. After saving, read the findings file with `read_file` before drafting
...
1. Write the content to the appropriate path with `write_file`
