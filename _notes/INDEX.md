...
- [debug-migration-review-gates-caught-two-latent-bugs](debug-migration-review-gates-caught-two-latent-bugs.md) — callback-adapter migration session journal; review gates caught the ContextVar-turn-state + approval-poll-identifier bugs green tests missed; pytest importlib / golden raw-churn / BaseTool.run callbacks gotchas.
